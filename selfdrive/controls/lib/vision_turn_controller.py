...
_NO_OVERSHOOT_TIME_HORIZON = 3.  # s. Time to use for velocity desired based on a_target when not overshooting.
...
_TURNING_ACC_BP = [1.7, 2.5, 3.]  # absolute value of current lat acc
