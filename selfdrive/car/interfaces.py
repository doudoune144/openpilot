...
class CarInterfaceBase(ABC):
  def __init__(self, CP, CarController, CarState):
    ...
    self.control_initialized_init = False
  ...
  def get_sp_cruise_main_state(self, cs_out):
    if not self.control_initialized:
      mads_enabled = False
    elif not self.control_initialized_init:
      mads_enabled = False
  ...
  def get_sp_common_state(self, cs_out, CS, min_enable_speed_pcm=False, gear_allowed=True, gap_button=False):
    ...
    if not self.control_initialized_init and CS.madsEnabled:
      self.control_initialized_init = True
